...
@section('content')
    ...
    {!! Form::open(['route' => 'admin.post.store', 'files' => true]) !!}
        ...
        <p class="text-right"><input type="checkbox" id="draft" name="draft"> <label for="draft" class="mr-3">Create as draft</label> <button type="submit" id="create_post" class="btn btn-primary">Create post</button></p>
